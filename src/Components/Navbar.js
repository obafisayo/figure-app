        ...
        <StyledHeader className="navigation is-home-link-shown is-home" ref={navRef}>
            <div className="navigation__content">
                ...
                <div className="navigation__home-link-wrapper">
                    <Link className="navigation__home-link is-active" title="Home" href="/">
                ...
                <nav className="navigation__links-wrapper" aria-label="Main navigation">
                    <div className="navigation__links">
                        <Link class="navigation__link" title="About Us" to="/about-us">
                            <div class="navigation__link-background"></div>
                            <span class="navigation__link-button-text">About Us</span>
                        </Link>
                        <div class="navigation__link-separator"></div>
                        <Link class="navigation__link" title="Master Plan" to="/master-plan">
                            <div class="navigation__link-background"></div>
                            <span class="navigation__link-button-text">Master Plan</span>
                        </Link>
                        <div class="navigation__link-separator"></div>
                        <Link class="navigation__link" title="Culture" to="/culture">
                            <div class="navigation__link-background"></div>
                            <span class="navigation__link-button-text">Culture</span>
                        </Link>
                        <div class="navigation__link-separator"></div>
                        <Link class="navigation__link" title="Careers" to="/careers">
                            <div class="navigation__link-background"></div>
                            <span class="navigation__link-button-text">Careers</span>
                        </Link>
