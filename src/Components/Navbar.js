...
const StyledHeader = styled.header`
    ...
    @media screen and  (min-width: 768px){
        ...
        .navigation__home-link.active-logo { // logo
            width: 3.6rem;
            height: 3.6rem;
            :hover{
                transition:background-color .3s ease-in-out;
                ...
                <nav className="navigation__links-wrapper" aria-label="Main navigation">
                    <Totop component={
                        <div className="navigation__links" >
                            <Link onClick={newhandleClick} className="navigation__link about__nav-link" title="About Us" to="/about-us" >
                            ...
                            <Link onClick={newhandleClick} className="navigation__link master__nav-link" title="Master Plan" to="/master-plan" >
                                <div className="navigation__link-background"></div>
                                <span className="navigation__link-button-text">Master Plan</span>
                            </Link>
                            <div className="navigation__link-separator"></div>
                            <Link onClick={newhandleClick}  className="navigation__link culture__nav-link" title="Culture" to="/culture" >
                                <div className="navigation__link-background"></div>
                                <span className="navigation__link-button-text">Culture</span>
                            </Link>
                            <div className="navigation__link-separator"></div>
                            <Link onClick={newhandleClick} className="navigation__link career__nav-link" title="Careers" to="/careers" >
                                <div className="navigation__link-background"></div>
